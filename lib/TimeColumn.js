...
var TimeColumn = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderTimeSliceGroup = function renderTimeSliceGroup(key, isNow, date, resource) {
  ...
  _proto.render = function render() {
    ...
    for (var i = 0; i < numGroups; i++) {
      isNow = localizer.inRange(now, date, localizer.add(next, groupLengthInMinutes - 1, 'minutes'), 'minutes');
