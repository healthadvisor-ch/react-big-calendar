...
var _excluded = ["view", "date", "getNow", "onNavigate"],
    _excluded2 = ["view", "toolbar", "events", "style", "className", "elementProps", "date", "getNow", "length", "showMultiDayTimes", "components", "formats", "messages", "culture"];
...
var Calendar = /*#__PURE__*/function (_React$Component) {
  ...
  function Calendar() {
    ...
    _this.getView = function () {
      ...
      return views[_this.props.view || _this.props.defaultView || 'week'];
    };
  ...
  _proto.render = function render() {
    var _this$props3 = this.props,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props3, _excluded2);
    ...
    return /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({}, elementProps, {
      ...
      localizer: localizer
    }), /*#__PURE__*/_react.default.createElement(View, (0, _extends2.default)({
      ref: "view"
    }, props, {
      events: events,
      date: current,
...
Calendar.propTypes = {
   ...
   * @type {(func|string)}
   */
  iconAccessor: _propTypes2.accessor,
   ...
   * @type {'date'|'resource'}
   */
  resourcesGroupBy: _propTypes.default.oneOf(['date', 'resource']),
