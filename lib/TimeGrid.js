...
var TimeGrid = /*#__PURE__*/ (function(_Component) {
  ...
  function TimeGrid(props) {
    ...
    _this.gutterRef = /*#__PURE__*/ _react.default.createRef()
  ...
  _proto.positionTimeIndicator = function positionTimeIndicator() {
    ...
    var timeGutter =
      (_this$gutterRef = this.gutterRef) == null
        ? void 0
        : _this$gutterRef.current
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(
    ...
    var _this$props2 = this.props,
      ...
      scrollToTime = _this$props2.scrollToTime // When paginating, reset scroll
  ...
  _proto.measureGutter = function measureGutter() {
    ...
    this.measureGutterAnimationFrameRequest = window.requestAnimationFrame(
      function() {
        var _this6$gutterRef

        var width = (0, _width.default)(
          (_this6$gutterRef = _this6.gutterRef) == null
            ? void 0
            : _this6$gutterRef.current
        )

        if (width && _this6.state.gutterWidth !== width) {
          _this6.setState({
            gutterWidth: width,
          })
        }
