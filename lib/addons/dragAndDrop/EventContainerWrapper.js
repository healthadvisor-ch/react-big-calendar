...
var EventContainerWrapper = /*#__PURE__*/function (_React$Component) {
  ...
  function EventContainerWrapper() {
    ...
    _this.handleMove = function (point, boundaryBox) {
      ...
      var end = localizer.add(currentSlot, localizer.diff(eventStart, eventEnd, 'minutes'), 'minutes');
  ...
  _proto.handleResize = function handleResize(point, boundaryBox) {
    ...
    if (direction === 'UP') {
      ...
      start = localizer.min(currentSlot, slotMetrics.closestSlotFromDate(end, -1));
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, children, event && /*#__PURE__*/_react.default.createElement(_TimeGridEvent.default, {
      event: event,
      label: label,
