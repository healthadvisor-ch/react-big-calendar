...
var Selection = /*#__PURE__*/ (function() {
  ...
  _proto._handleInitialEvent = function _handleInitialEvent(e) {
    ...
    setTimeout(function() {
      var result = _this3.emit(
        'beforeSelect',
        (_this3._initialEventData = {
      ...
      switch (e.type) {
        case 'mousedown':
          _this3._onEndListener = addEventListener(
            'mouseup',
            _this3._handleTerminatingEvent
          )
          _this3._onMoveListener = addEventListener(
            'mousemove',
            _this3._handleMoveEvent
          )
          break

        case 'touchstart':
          _this3._handleMoveEvent(e)
