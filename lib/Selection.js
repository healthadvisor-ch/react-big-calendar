...
var Selection = /*#__PURE__*/ (function() {
  ...
  _proto._handleInitialEvent = function _handleInitialEvent(e) {
    ...
    var node = this.container(),
      ...
      offsetData
    console.log(
      'selection - handle initial event! e.which: ' +
        e.which +
        ' e.button: ' +
        e.button +
        ', isOver..: ' +
  ...
  _proto._isWithinValidContainer = function _isWithinValidContainer(e) {
  ...
  _proto._handleTerminatingEvent = function _handleTerminatingEvent(e) {
    console.log(
      'sel - handleTerminatingEvent, initial event data: ' +
        !!this._initialEventData
    )
  ...
  _proto._handleMoveEvent = function _handleMoveEvent(e) {
    ...
    var isClick = this.isClick(pageX, pageY)
    console.log(
