...
var TimeGridHeader = /*#__PURE__*/ (function(_React$Component) {
  ...
  _proto.renderGroupedByDate = function renderGroupedByDate() {
    ...
    var _this$props4 = this.props,
      ...
      _this$props4$componen = _this$props4.components.resourceHeader,
      ResourceHeaderComponent =
        _this$props4$componen === void 0
          ? _ResourceHeader.default
          : _this$props4$componen
    return range.map(function(date, rangeIndex) {
      var groupedEventsPerDay = resources.groupEvents(
        _this4.getEventsForDay(events, date)
      )
      return /*#__PURE__*/ _react.default.createElement(
        'div',
        {
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          resources.map(function(_ref, idx) {
            ...
            return /*#__PURE__*/ _react.default.createElement(
              ...
              _this4.getDateContentRow(groupedEventsPerDay, resource, id, [
                date,
              ])
            )
          })
  ...
  _proto.render = function render() {
    var _this$props6 = this.props,
      ...
      scrollRef = _this$props6.scrollRef,
      isOverflowing = _this$props6.isOverflowing,
      resourcesGroupBy = _this$props6.resourcesGroupBy,
      TimeGutterHeader = _this$props6.components.timeGutterHeader
    var style = {}
