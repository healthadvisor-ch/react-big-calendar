...
var TimeGridHeader = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.renderHeaderSingleCell = function renderHeaderSingleCell(date, i) {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      key: i,
      style: style,
      className: (0, _classnames.default)('rbc-header', className, localizer.isSameDate(date, today) && 'rbc-today')
  ...
  _proto.getDateContentRow = function getDateContentRow(groupedEvents, resource, resourceId, range) {
  ...
  _proto.getEventsForDay = function getEventsForDay(events, date) {
    ...
    events.forEach(function (event) {
      ...
      if (localizer.inRange(date, eStart, eEnd)) {
        if (accessors.allDay(event) || (0, _dates.isJustDate)(eStart) && (0, _dates.isJustDate)(eEnd)) {
  ...
  _proto.renderGroupedByDate = function renderGroupedByDate() {
    ...
    var _this$props5 = this.props,
        ...
        ResourceHeaderComponent = _this$props5$componen === void 0 ? _ResourceHeader.default : _this$props5$componen;
    return range.map(function (date, rangeIndex) {
      var groupedEventsPerDay = resources.groupEvents(_this4.getEventsForDay(events, date));
      return /*#__PURE__*/_react.default.createElement("div", {
        className: (0, _classnames.default)('rbc-time-header-content', resources.length > 1 && 'rbc-time-header-content-last-in-resource'),
        key: rangeIndex
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: "rbc-row rbc-time-header-cell"
      }, _this4.renderHeaderSingleCell(date, rangeIndex)), /*#__PURE__*/_react.default.createElement("div", {
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          key: id
        }, resource && /*#__PURE__*/_react.default.createElement(ResourceHeaderComponent, {
          index: idx,
          label: accessors.resourceTitle(resource),
          resource: resource
        }), _this4.getDateContentRow(groupedEventsPerDay, resource, id, [date]));
      })));
    });
  };
  ...
  _proto.renderGroupedByResource = function renderGroupedByResource() {
    ...
    var _this$props6 = this.props,
        ...
        ResourceHeaderComponent = _this$props6$componen === void 0 ? _ResourceHeader.default : _this$props6$componen;
    ...
    return resources.map(function (_ref2, idx) {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        label: accessors.resourceTitle(resource),
        resource: resource
      }))), range.length > 1 && /*#__PURE__*/_react.default.createElement("div", {
        className: "rbc-row rbc-time-header-cell"
      }, _this5.renderHeaderCells(range)), _this5.getDateContentRow(groupedEvents, resource, id, range));
    });
  };
  ...
  _proto.render = function render() {
    ...
    }, TimeGutterHeader && /*#__PURE__*/_react.default.createElement(TimeGutterHeader, null)), resourcesGroupBy === 'date' && this.renderGroupedByDate(), resourcesGroupBy === 'resource' && this.renderGroupedByResource());
  };
