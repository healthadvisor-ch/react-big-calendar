...
function _format(localizer, formatter, value, format, culture) {
  ...
  !(result == null || typeof result === 'string') ? process.env.NODE_ENV !== "production" ? (0, _invariant.default)(false, '`localizer format(..)` must return a string, null, or undefined') : (0, _invariant.default)(false) : void 0;
  return result;
}
/**
...
var DateLocalizer = function DateLocalizer(spec) {
  ...
  !(typeof spec.format === 'function') ? process.env.NODE_ENV !== "production" ? (0, _invariant.default)(false, 'date localizer `format(..)` must be a function') : (0, _invariant.default)(false) : void 0;
  !(typeof spec.firstOfWeek === 'function') ? process.env.NODE_ENV !== "production" ? (0, _invariant.default)(false, 'date localizer `firstOfWeek(..)` must be a function') : (0, _invariant.default)(false) : void 0;
