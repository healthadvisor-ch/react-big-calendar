...
var BackgroundCells = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      var _getters$dayProp = getters.dayProp(date, resourceId),
      ...
      return /*#__PURE__*/_react.default.createElement(Wrapper, {
        ...
        style: style,
        className: (0, _classnames.default)('rbc-day-bg', className, selected && 'rbc-selected-cell', localizer.eq(date, current, 'day') && 'rbc-today', currentDate && localizer.neq(currentDate, date, 'month') && 'rbc-off-range-bg')
      }));
    }));
  };
