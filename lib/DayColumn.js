...
var DayColumn = /*#__PURE__*/function (_React$Component) {
  ...
  function DayColumn() {
    ...
    _this.renderEvents = function () {
      ...
      return styledEvents.map(function (_ref, idx) {
        ...
        if (event.label) label = event.label;else if (startsBeforeDay && startsAfterDay) label = messages.allDay;else label = localizer.format({
          start: start,
          end: end
        }, format);
    ...
    _this._selectable = function () {
      ...
      selector.on('select', function (bounds) {
        if (_this.state.selecting) {
          _this._selectSlot((0, _extends3.default)({}, _this.state, {
            action: 'select',
            bounds: bounds
          }));
    ...
    _this._selectSlot = function (_ref2) {
      ...
      var current = startDate,
          repeatLimit = 24 * 60 / _this.props.step,
          slots = [];

      while (_this.props.localizer.lte(current, endDate) && repeatLimit) {
        repeatLimit--;
        slots.push(current);
  ...
  _proto.render = function render() {
    ...
    var dataProps = Object.keys(data || {}).reduce(function (all, prop) {
      ...
      return (0, _extends3.default)({}, all, (_extends2 = {}, _extends2["data-" + prop] = data[prop], _extends2));
    }, {});
    return /*#__PURE__*/_react.default.createElement("div", (0, _extends3.default)({
      style: style
    }, dataProps, {
      className: (0, _classnames.default)(className, this.props.className, 'rbc-day-slot', 'rbc-time-column', isNow && 'rbc-now', isNow && 'rbc-today', // WHY
    ...
    }, /*#__PURE__*/_react.default.createElement("span", null, localizer.format(selectDates, 'selectRangeFormat'))));
  };
